...
当前 ZIP SHA-256：912D20DF7FA6C5FE02640AF52E80679609280C74ADDBA36295808D4108CD4993。

注释中文化更新：五个 C 文件的解释性注释已翻译；逐文件比对确认可执行文本未改，GitHub 最新作者、日期与版权头原样保留，压缩包内容与当前源文件逐字节一致。上面的编译及行为测试为此前逻辑版本的记录，本次纯注释修改未重复运行。
